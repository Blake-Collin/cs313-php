...
INSERT INTO description (description_text, duration, complexity, min_players, max_players)
	VALUES ('Boldly go where no one has gone before. In Star Trek: Ascendancy — a board game of exploration, expansion and conflict between the United Federation of Planets, the Klingon Empire, and the Romulan Star Empire — you control the great civilizations of the Galaxy, striking out from your home worlds to expand your influence and grow your civilization. Will you journey for peace and exploration, or will you travel the path of conquest and exploitation? Command starships, establish space lanes, construct starbases, and bring other systems under your banner. With more than 200 plastic miniatures and 30 star systems representing some of the Star Trek galaxy''s most notable planets and locations, Star Trek: Ascendancy puts the fate of the galaxy in your hands.',
			'180', '3', '3', '3');
INSERT INTO description (description_text, duration, complexity, min_players, max_players)
	VALUES ('Twilight Imperium (Fourth Edition) is a game of galactic conquest in which three to six players take on the role of one of seventeen factions vying for galactic domination through military might, political maneuvering, and economic bargaining. Every faction offers a completely different play experience, from the wormhole-hopping Ghosts of Creuss to the Emirates of Hacan, masters of trade and economics. These seventeen races are offered many paths to victory, but only one may sit upon the throne of Mecatol Rex as the new masters of the galaxy.',
			'240', '4', '3', '6');
INSERT INTO description (description_text, duration, complexity, min_players, max_players)
	VALUES ('In War of the Ring, one player takes control of the Free Peoples (FP), the other player controls Shadow Armies (SA). Initially, the Free People Nations are reluctant to take arms against Sauron, so they must be attacked by Sauron or persuaded by Gandalf or other Companions, before they start to fight properly: this is represented by the Political Track, which shows if a Nation is ready to fight in the War of the Ring or not.',
			'150', '4', '2', '4');
	
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('59.99', '59.99', '59.99');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('59.99', '59.99', '59.99');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('49.99', '49.99', '49.99');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('149.99', '149.99', '149.99');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('99.99', '99.99', '99.99');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('149.95', '149.95', '149.95');
INSERT INTO msrp (msrp_price, historical_low, historical_high)
	VALUES ('89.99', '89.99', '89.99');
	
INSERT INTO images (img_name, alt_txt)
	VALUES ('battlestargalactica.jpg', 'Box art for Battlestar Galatica the Board Game');
INSERT INTO images (img_name, alt_txt)
	VALUES ('brassbirmingham.jpg', 'Box Art for Brass Brimingham');
INSERT INTO images (img_name, alt_txt)
	VALUES ('sekigahara.jpg', 'Box Art for Sekigahara');
INSERT INTO images (img_name, alt_txt)
	VALUES ('startrekascendancy.jpg', 'Box Art For Star Trek Ascendancy');
INSERT INTO images (img_name, alt_txt)
	VALUES ('startrekfleetcaptains.jpg', 'Box Art for Star Trek Fleet Captains');
INSERT INTO images (img_name, alt_txt)
	VALUES ('twilightimperium.jpg', 'Box Art for Twilight Imperium 4th Edition');
INSERT INTO images (img_name, alt_txt)
	VALUES ('warofthering2nd.jpg', 'Box Art for War of the Ring 2nd Edition');

INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Battlestar Galactica: The Board Game', '1', '1', '1');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Brass: Birmingham', '2', '2', '2');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Sekigahara: The Unification of Japan', '3', '3', '3');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Star Trek: Fleet Captains', '4', '4', '4');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Star Trek: Ascendancy', '5', '5', '5');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('Twilight Imperium (Fourth Edition)', '6', '6', '6');
INSERT INTO games (name, description_id, msrp_id, images_id)
	VALUES ('War of the Ring: Second Edition', '7', '7', '7');
	
--Test our items are working and connected
SELECT games.name, images.img_name, images.alt_txt
FROM games, images
WHERE games.images_id = images.images_id;
